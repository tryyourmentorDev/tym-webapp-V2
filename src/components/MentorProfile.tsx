...
import { ArrowLeft, Star, MapPin, Clock, Globe, MessageCircle, Calendar, Heart, Share } from 'lucide-react';
...
export const MentorProfile: React.FC<MentorProfileProps> = ({ mentor, onBack }) => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center gap-6 mb-6 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className={`font-medium ${mentor.availability === 'Available' ? 'text-green-600' : 'text-orange-600'}`}>
                    {mentor.availability}
                  </span>
                </div>
                <div className="flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {[
                  {
                    ...
                    rating: 5,
                    comment: 'Incredible mentor! Helped me transition from junior to senior engineer in just 8 months.',
                    date: '2 weeks ago'
                  },
                  {
                    name: 'Jessica Liu',
                    ...
                    rating: 5,
                    comment: 'Amazing guidance on product strategy. Very knowledgeable and patient.',
                    date: '1 month ago'
                  },
                  {
                    name: 'Michael Chen',
                    role: 'Data Scientist',
                    rating: 4,
                    comment: 'Great insights into machine learning and career development. Highly recommend!',
                    date: '2 months ago'
                  }
                ].map((review, index) => (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">{mentor.industry}</span>
                </div>
                <div className="flex justify-between">
            ...
            {/* Similar Mentors */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Similar Mentors</h3>
              <div className="space-y-4">
                {[
                  { name: 'John Smith', title: 'Senior Engineer at Meta', rating: 4.8 },
                  { name: 'Lisa Wang', title: 'Tech Lead at Amazon', rating: 4.9 },
                  { name: 'Carlos Rodriguez', title: 'Principal Engineer at Tesla', rating: 4.7 }
                ].map((similar, index) => (
                  <div key={index} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 text-sm truncate">{similar.name}</p>
                      <p className="text-gray-600 text-xs truncate">{similar.title}</p>
                    </div>
                    <div className="flex items-center">
      ...
      {showContactForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Send Message to {mentor.name}</h3>
            <textarea
              value={message}
